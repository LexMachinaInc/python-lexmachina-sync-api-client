...
class AppealsCaseData(BaseModel):
    ...
    docket: Docket
    __properties: ClassVar[List[str]] = ["appealsCaseId", "title", "court", "civilActionNumber", "status", "caseTags", "dates", "judges", "lawFirms", "attorneys", "parties", "originatingVenues", "originatingCases", "appealabilityRulings", "caseResolution", "supremeCourtAndRehearingDecisions", "docket"]
