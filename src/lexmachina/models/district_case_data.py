...
class DistrictCaseData(BaseModel):
    ...
    nature_of_suit: Optional[NatureOfSuit] = Field(default=None, alias="natureOfSuit")
    __properties: ClassVar[List[str]] = ["districtCaseId", "title", "court", "caseNo", "status", "caseType", "caseTags", "dates", "resolution", "events", "judges", "magistrateJudges", "remedies", "findings", "lawFirms", "attorneys", "parties", "damages", "patents", "orders", "mdl", "appealsCases", "docket", "complaintSummary", "natureOfSuit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nature_of_suit
        if self.nature_of_suit:
            _dict['natureOfSuit'] = self.nature_of_suit.to_dict()
        ...
        # set to None if nature_of_suit (nullable) is None
        # and model_fields_set contains the field
        if self.nature_of_suit is None and "nature_of_suit" in self.model_fields_set:
            _dict['natureOfSuit'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "natureOfSuit": NatureOfSuit.from_dict(obj["natureOfSuit"]) if obj.get("natureOfSuit") is not None else None
        })
        return _obj
