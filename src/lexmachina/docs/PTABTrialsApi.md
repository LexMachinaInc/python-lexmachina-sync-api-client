...
[**get_ptab_trial_by_number**](PTABTrialsApi.md#get_ptab_trial_by_number) | **GET** /ptab-trials/{ptab_trial_number} | Get Ptab Trial By Number
...
# **get_ptab_trial_by_number**
> PTABTrialData get_ptab_trial_by_number(ptab_trial_number)

Get Ptab Trial By Number

Gets data for a single PTAB trial via the trial number.
...
with lexmachina.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lexmachina.PTABTrialsApi(api_client)
    ptab_trial_number = 'ptab_trial_number_example' # str | 

    try:
        # Get Ptab Trial By Number
        api_response = api_instance.get_ptab_trial_by_number(ptab_trial_number)
        print("The response of PTABTrialsApi->get_ptab_trial_by_number:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PTABTrialsApi->get_ptab_trial_by_number: %s\n" % e)
```
