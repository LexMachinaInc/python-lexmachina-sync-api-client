...
class StateCaseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["stateCaseId", "title", "state", "court", "caseNo", "status", "caseType", "caseTags", "dates", "resolution", "events", "judges", "rulings", "lawFirms", "attorneys", "parties", "damages"]
