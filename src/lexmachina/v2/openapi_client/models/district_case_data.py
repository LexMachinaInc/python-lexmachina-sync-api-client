...
class DistrictCaseData(BaseModel):
    ...
    docket: Docket
    __properties: ClassVar[List[str]] = ["districtCaseId", "title", "court", "caseNo", "status", "caseType", "caseTags", "dates", "resolution", "events", "judges", "magistrateJudges", "remedies", "findings", "lawFirms", "attorneys", "parties", "damages", "patents", "orders", "mdl", "appealsCases", "docket"]
