    ...
    def make_instance(self, include_optional) -> JudgeSearchResult:
        ...
        if include_optional:
            return JudgeSearchResult(
                federal_judges = [
                    openapi_client.models.federal_judge_result.FederalJudgeResult(
                        name = '', 
                        federal_judge_id = 56, 
                        initials = '', 
                        case_count_by_court = [
                ...
                magistrate_judges = [
                    openapi_client.models.magistrate_judge_result.MagistrateJudgeResult(
                        name = '', 
                ...
                state_judges = [
                    openapi_client.models.state_judge_result.StateJudgeResult(
                        name = '', 
                        state_judge_id = 56, 
                        court_posting = '', 
                        url = '', )
                ...
                bankruptcy_judges = [
                    openapi_client.models.bankruptcy_judge_result.BankruptcyJudgeResult(
                        name = '', 
