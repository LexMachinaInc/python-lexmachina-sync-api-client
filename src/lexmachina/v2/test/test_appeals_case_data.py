    ...
    def make_instance(self, include_optional) -> AppealsCaseData:
        ...
        if include_optional:
            return AppealsCaseData(
                ...
                dates = openapi_client.models.appeals_case_dates.AppealsCaseDates(
                ...
                originating_cases = [
                    openapi_client.models.originating_district_court_case.OriginatingDistrictCourtCase(
                        district_case_id = 56, 
                        district_case_url = '', 
                        judges = [
                            null
                ...
                case_resolution = openapi_client.models.case_resolution.CaseResolution(
                    summary = '', 
                    specific = '', ),
                supreme_court_and_rehearing_decisions = [
                    openapi_client.models.supreme_court_or_rehearing_decision.SupremeCourtOrRehearingDecision(
