...
class TestDistrictCaseDates(unittest.TestCase):
    """DistrictCaseDates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistrictCaseDates:
        """Test DistrictCaseDates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DistrictCaseDates`
        """
        model = DistrictCaseDates()
        if include_optional:
            return DistrictCaseDates(
    ...
    def testDistrictCaseDates(self):
        """Test DistrictCaseDates"""
