    ...
    def make_instance(self, include_optional) -> ITCInvestigationData:
        ...
        if include_optional:
            return ITCInvestigationData(
                ...
                status = 'Active',
                dates = openapi_client.models.itc_investigation_dates.ITCInvestigationDates(
                ...
                administrative_law_judges = [
                    openapi_client.models.administrative_law_judge.AdministrativeLawJudge(
                        name = '', )
                    ],
                dispositions = [
                    ''
                ...
                parties = [
                    openapi_client.models.itc_party.ITCParty(
                        name = '', 
                        role = '', )
                    ],
                patents = [
                ...
                itc_document_list = openapi_client.models.itc_document_list.ITCDocumentList(
                    entries = [
                        openapi_client.models.itc_document.ITCDocument(
                            usitc_document_id = 56, 
                            date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                            title = '', 
                            type = '', 
                            filed_by = [
                                openapi_client.models.itc_document_entity_data.ITCDocumentEntityData(
                                    name = '', )
                                ], 
                            firm = [
                                openapi_client.models.itc_document_entity_data.ITCDocumentEntityData(
