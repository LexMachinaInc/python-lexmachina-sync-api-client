...
class TestTimingFilter(unittest.TestCase):
    """TimingFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimingFilter:
        """Test TimingFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimingFilter`
        """
        model = TimingFilter()
        if include_optional:
            return TimingFilter(
