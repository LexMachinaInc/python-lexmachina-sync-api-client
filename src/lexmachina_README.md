...
*AnalyticsApi* | [**analyze_district_cases_from_alert**](lexmachina/docs/AnalyticsApi.md#analyze_district_cases_from_alert) | **GET** /analyze-district-cases/from-alert/{alert_id} | Analyze District Cases From Alert
*AnalyticsApi* | [**analyze_district_cases_from_query**](lexmachina/docs/AnalyticsApi.md#analyze_district_cases_from_query) | **POST** /analyze-district-cases/from-query | Analyze District Cases From Query
...
*EntitiesApi* | [**get_parties**](lexmachina/docs/EntitiesApi.md#get_parties) | **GET** /parties | Get Parties
...
*FederalDistrictCasesApi* | [**analyze_district_cases_from_alert**](lexmachina/docs/FederalDistrictCasesApi.md#analyze_district_cases_from_alert) | **GET** /analyze-district-cases/from-alert/{alert_id} | Analyze District Cases From Alert
*FederalDistrictCasesApi* | [**analyze_district_cases_from_query**](lexmachina/docs/FederalDistrictCasesApi.md#analyze_district_cases_from_query) | **POST** /analyze-district-cases/from-query | Analyze District Cases From Query
...
*ListApi* | [**list_case_types**](lexmachina/docs/ListApi.md#list_case_types) | **GET** /list-case-types/{court_type} | List Case Types
...
*ListApi* | [**list_remedies**](lexmachina/docs/ListApi.md#list_remedies) | **GET** /list-remedies/FederalDistrict | List Remedies
...
*PTABTrialsApi* | [**get_ptab_trial_by_number**](lexmachina/docs/PTABTrialsApi.md#get_ptab_trial_by_number) | **GET** /ptab-trials/{ptab_trial_number} | Get Ptab Trial By Number
...
*PartiesApi* | [**get_party_groups**](lexmachina/docs/PartiesApi.md#get_party_groups) | **GET** /party-groups | Get Party Groups
...
## Documentation For Models
 ...
 - [AdministrativeLawJudge](lexmachina/docs/AdministrativeLawJudge.md)
 ...
 - [Aggregation](lexmachina/docs/Aggregation.md)
 ...
 - [AnalyticTypes](lexmachina/docs/AnalyticTypes.md)
 ...
 - [CaseAnalyticResult](lexmachina/docs/CaseAnalyticResult.md)
 - [CaseCountByCourt](lexmachina/docs/CaseCountByCourt.md)
 - [CaseCountByType](lexmachina/docs/CaseCountByType.md)
 ...
 - [CaseTypeAggregation](lexmachina/docs/CaseTypeAggregation.md)
 ...
 - [CountsPerRole](lexmachina/docs/CountsPerRole.md)
 ...
 - [DistrictCaseAnalyticFromQuery](lexmachina/docs/DistrictCaseAnalyticFromQuery.md)
 ...
 - [DistrictCaseResolution](lexmachina/docs/DistrictCaseResolution.md)
 ...
 - [EventsList](lexmachina/docs/EventsList.md)
 ...
 - [HealthStatus](lexmachina/docs/HealthStatus.md)
 ...
 - [LawFirmAggregation](lexmachina/docs/LawFirmAggregation.md)
 - [LawFirmCountByRole](lexmachina/docs/LawFirmCountByRole.md)
 ...
 - [NatureOfSuit](lexmachina/docs/NatureOfSuit.md)
 ...
 - [OriginatingDistrictCourtCaseJudgesInner](lexmachina/docs/OriginatingDistrictCourtCaseJudgesInner.md)
 ...
 - [PartyAggregation](lexmachina/docs/PartyAggregation.md)
 - [PartyCountByRole](lexmachina/docs/PartyCountByRole.md)
 - [PartyData](lexmachina/docs/PartyData.md)
 - [PartyFilter](lexmachina/docs/PartyFilter.md)
 - [PartyGroup](lexmachina/docs/PartyGroup.md)
 ...
 - [PossibleCaseResolution](lexmachina/docs/PossibleCaseResolution.md)
 - [PriorArt](lexmachina/docs/PriorArt.md)
 - [RemediesList](lexmachina/docs/RemediesList.md)
 ...
 - [StateCaseResolution](lexmachina/docs/StateCaseResolution.md)
